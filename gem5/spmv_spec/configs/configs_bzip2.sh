...
SE_NAME=spec06_bzip2 # 改这个
FS_NAME=spmv

#改下面两个
SE_ELF_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/401.bzip2/exe/bzip2_base.armv7-gcc # 改这个
SE_INPUT_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/401.bzip2/data/all/input/input.program # 改这个
