...
SE_ELF_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/403.gcc/exe/gcc_base.armv7-gcc # 改这个
SE_INPUT_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/403.gcc/data/test/input/cccp.in # 改这个
