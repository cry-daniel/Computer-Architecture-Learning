...
SE_NAME=spec06_gobmk
FS_NAME=spmv

SE_ELF_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/445.gobmk/exe/gobmk_base.armv7-gcc # 改这个
SE_INPUT_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/445.gobmk/data/test/input/capture.tst # 改这个
