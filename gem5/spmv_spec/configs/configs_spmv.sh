...
SE_OR_FS=FS # FS/SE 改这个
FS_COMMAND=/home/data/ChenRuiyang/sh_command/spmv_spec/run.sh

SE_NAME=spec06_gcc # 改这个
FS_NAME=spmv # 改这个

#改下面两个
SE_ELF_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/401.bzip2/exe/bzip2_base.armv7-gcc
SE_INPUT_ROUTE=/home/data/ChenRuiyang/spec06/benchspec/CPU2006/401.bzip2/data/all/input/input.program
