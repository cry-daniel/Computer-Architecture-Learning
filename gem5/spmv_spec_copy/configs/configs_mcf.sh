...
SE_ELF_ROUTE=~/ChenRuiyang/spec06/benchspec/CPU2006/429.mcf/exe/mcf_base.armv7-gcc # 改这个
SE_INPUT_ROUTE=~/ChenRuiyang/spec06/benchspec/CPU2006/429.mcf/data/test/input/test/input/inp.in # 改这个
