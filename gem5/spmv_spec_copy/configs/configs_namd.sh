...
SE_ELF_ROUTE=~/ChenRuiyang/spec06/benchspec/CPU2006/444.namd/exe/namd_base.armv7-gcc # 改这个
SE_INPUT_ROUTE=~/ChenRuiyang/spec06/benchspec/CPU2006/444.namd/data/all/input/namd.input # 改这个
