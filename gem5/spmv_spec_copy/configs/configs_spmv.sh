...
#改下面两个
SE_ELF_ROUTE=~/ChenRuiyang/spec06/benchspec/CPU2006/401.bzip2/exe/bzip2_base.armv7-gcc
SE_INPUT_ROUTE=~/ChenRuiyang/spec06/benchspec/CPU2006/401.bzip2/data/all/input/input.program
