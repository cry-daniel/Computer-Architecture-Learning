...
sudo aarch64-linux-gnu-gcc-10  -c -I/home/fugelin/Tools/arm/armpl_21.0_gcc-10.2/include -std=c11 -march=armv8-a+nosimd+nosve -I ~/gem5/include ${object}.c -o ${object}.o
