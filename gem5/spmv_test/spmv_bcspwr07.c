...
int main()
{
	...
	fp=freopen("./data/bcspwr07/info.txt","r",stdin);
	scanf("%d %d %d",&NNZ,&M,&N);
	fclose(fp);

	fp=freopen("./data/bcspwr07/nnz.txt","r",stdin);
	/*while(scanf("%lf",&temp)){
		vals[cnt++]=temp;
	}*/
	for(int i=1;i<=NNZ;i++){
	...
	fp=freopen("./data/bcspwr07/row.txt","r",stdin);
	/*while(scanf("%d",&temp1)){
		row_ptr[cnt++]=temp1;
	}*/
	for(int i=1;i<=M+1;i++){
	...
	fp=freopen("./data/bcspwr07/col.txt","r",stdin);
	/*while(scanf("%d",&temp1)){
		col_indx[cnt++]=temp1;
	}*/
	for(int i=1;i<=NNZ;i++){
