...
SE_NAME=spec17_gcc_long # 改这个
FS_NAME=spmv

SPEC_ROUTE=/home/data/ChenRuiyang/spec17/benchspec/CPU

SE_ELF_ROUTE=${SPEC_ROUTE}/502.gcc_r/exe/cpugcc_r_base.mytest-64 # 改这个
SE_INPUT_ROUTE=${SPEC_ROUTE}/502.gcc_r/data/train/input/200.c # 改这个
OPTIONS=' -O3 -finline-limit=50000 -o '$1'200.opts-O3_-finline-limit_50000.s' # 改这个
